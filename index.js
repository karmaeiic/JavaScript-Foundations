...
const total = numberator / denominator;
const monthlyRate = principal * total;
...
{
    return ((P * (((I / 12) * Math.pow((1 + (I / 12)), (N * 12))) / (Math.pow((1 + (I / 12)), (N * 12)) - 1)) * 100) / 100)
}
...
function creditScore(P, I, N, creditScore) {
    if (creditScore > 740) {
        let I = I - 0.005;
